...
public class NullableUnicodeStringCodecTest extends OpenFastTestCase {
    ...
    public void testEncode() {
        assertEquals("10000111 11001110 10110001 11001110 10110010 11001110 10110011", encode(new String("\u03B1\u03B2\u03B3")));
        assertEquals("10000100 01100001 01100010 01100011", encode(new String("abc")));
    }
