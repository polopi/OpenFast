...
//        String prepend = newValue.substring(0, value.length() - prependIndex + 1);
    ...
    public static Date toTimestamp(long value) {
		...
		int year = (int) (valueLocal / 10000000000000L);
		valueLocal %= 10000000000000L;
        int month = (int) (valueLocal / 100000000000L);
        valueLocal %= 100000000000L;
        int day = (int) (valueLocal / 1000000000);
        valueLocal %= 1000000000;
        int hour = (int) (valueLocal / 10000000);
        valueLocal %= 10000000;
        int min = (int) (valueLocal / 100000);
        valueLocal %= 100000;
        int sec = (int) (valueLocal / 1000);
        int ms = (int) (valueLocal % 1000);
