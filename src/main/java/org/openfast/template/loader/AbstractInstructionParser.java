...
public abstract class AbstractInstructionParser implements InstructionParser {
    private String[] parseableNodeNames;

    protected AbstractInstructionParser(String nodeName) {
        this(new String[] { nodeName });
    }

    protected AbstractInstructionParser(String[] nodeNames) {
